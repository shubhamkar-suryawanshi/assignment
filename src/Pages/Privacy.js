...
function Privacy() {
  return (
    <Container maxWidth="md" sx={{ textAlign: "left", marginTop: "4rem" }}>
      <Typography variant="h3">Privacy Policy</Typography> <br /> <br />
      <br />
      <Typography variant="p">
        ...
        track certain information about you based upon your behavior on our
        Website. We use this information to do internal research on our users'
        demographics, interests, and behavior to better understand, protect and
        ...
        (like zip code, age, or income level). We use this data to tailor your
        experience at our Website, providing you with content that we think you
        ...
        <br /> <br />
        <br />
        We may be sharing your personal details including name, address, DOB,
        phone number and email id with Banks for the purpose of providing
        Banking services including insurance, loans etc.
        <br /> <br />
        <br />
        We may also be sharing the historical data since your association with
        GreenKart.
        <br /> <br />
        <br />
        ...
        identifiable information about you. greenkart.com is not responsible for
        ...
        communications from us, then please email to info@greenkart.com
        <br /> <br />
        <br />
        ...
        Name: Surya S
        <br />
        Phone: +91- 1111111111 <br /> Email: info@greenkart.com
        <br /> Time: Mon to Fir (10:00 AM to 5:00 PM)
        <br /> <br />
        <br />
        9. Questions?
        <br />
